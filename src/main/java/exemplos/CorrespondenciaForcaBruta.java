...
/**
 * Refeerências
 * https://docs.opencv.org/4.0.1/d5/d51/group__features2d__main.html
 * https://docs.opencv.org/4.0.1/db/d95/classcv_1_1ORB.html
 *
 * @author robertosilva
 *
 */
public class CorrespondenciaForcaBruta extends CapturaVideo {

    private final String descricao = "Correspondência por Força Bruta";

    public CorrespondenciaForcaBruta() {
    ...
    public Mat processaFrame(Mat imgFrame) {
        ...
        Mat imgDestino = SURFFLANNMatchingHomography(imgFrame);
        ...
        //KeyPointVector kpv = new KeyPointVector();
        //Mat mask = new Mat();
        
        
        //ctAndCompute(imgFrame, imgDestino, kpv, mask);
        
        //Object extractor = DescriptorExtractor.create(DescriptorExtractor.ORB);
     ...
     public Mat SURFFLANNMatchingHomography(Mat imgScene) {
        
        //String filenameObject = args.length > 1 ? args[0] : "../data/box.png";
        //String filenameScene = args.length > 1 ? args[1] : "../data/box_in_scene.png";
        String filenameObject = "C:\\Users\\robertosilva\\Downloads\\whatsapplogo.png";
        //String filenameScene = "C:/Users/robertosilva/Downloads/whatsapplogobusca.png";
        ...
        org.opencv.features2d.DescriptorMatcher matcher = org.opencv.features2d.DescriptorMatcher.create(org.opencv.features2d.DescriptorMatcher.FLANNBASED);
        ...
        //-- Draw matches
        int   NOT_DRAW_SINGLE_POINTS = 2;
        Mat imgMatches = new Mat();
        Features2d.drawMatches(imgObject, keypointsObject, imgScene, keypointsScene, goodMatches, imgMatches, Scalar.all(-1),
                Scalar.all(-1), new MatOfByte(), NOT_DRAW_SINGLE_POINTS);
