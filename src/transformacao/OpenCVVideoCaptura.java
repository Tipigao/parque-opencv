 ...
 * @author Roberto
 */
public abstract class OpenCVVideoCaptura extends Observable implements Runnable, IOpenCV  {
    ...
    protected void pararCaptura() {
        try {
            ...
            Logger.getLogger(OpenCVVideoCaptura.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
